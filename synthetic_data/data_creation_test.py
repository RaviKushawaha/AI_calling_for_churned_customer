...
# save to CSVs
customer_profile.to_csv("../real_time_data/customer_profile_test.csv", index=False)
purchase_behavior.to_csv("../real_time_data/purchase_behavior_test.csv", index=False)
customer_support.to_csv("../real_time_data/customer_support_test.csv", index=False)
